...
include("includes/form_handlers/settings_handler.php");
 ...
 <div class="main_column column">
 	...
 	<h4>Change Password</h4>
 	 ...
 	 <form action="settings.php" method="POST">
 		Current Password: <input type="password" name="current_password" id="settings_input"><br>
 		New Password: <input type="password" name="new_password_1" id="settings_input"><br>
 		New Password Confirmed: <input type="password" name="new_password_2" id="settings_input"><br>
